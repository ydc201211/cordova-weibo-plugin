...
public class YCWeibo extends CordovaPlugin {
    ...
    private static final String DEFAULT_WEBPAGE_ICON = "http://www.toursforfun.com/img/app/code.png";
    ...
    private void sendMultiMessage(JSONObject params) {
        ...
        try {
            weiboMessage.imageObject = getImageObject(params);
    ...
    private TextObject getTextObj(JSONObject params) throws JSONException {
        ...
        sb.append(params.getString("title")).append(params.getString("url"));
     ...
     * @throws JSONException
     */
        private ImageObject getImageObject(JSONObject params) throws JSONException{
